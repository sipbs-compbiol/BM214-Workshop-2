...
- be able to name some of the major sequence databases that help us use sequence similarity to understand the possible origins and functions of biological sequences
