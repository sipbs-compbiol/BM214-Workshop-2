...
In this scenario, you have used a `BLASTX` search to **provide a preliminary annotation of a metagenome contig** and a **likely organism from which it might come**. You may have **modified your search to use a more comprehensive database** to obtain a **more precise annotation**, and compared the effects of database choice. You may have **investigated the domain structure of one of your predicted proteins** and **used a database of sequences from solved protein structures identify a representative structure** for one of your annotations.
:::